    ...
    <div class="content">
      <section>
        <div class="intro-services-to-be-billed">
          <h1 class="title-page">Situação do imóvel</h1>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      propertySituationTable: [
        {
          id: 0,
          code: "0",
          description: "Habitado",
          checkbox: null,
        },
        {
          id: 1,
        ...
        },
        {
          id: 3,
          code: "3",
          description: "Construção desabitada",
          checkbox: null,
        },
        {
          id: 4,
          code: "4",
          description: "Demolido",
          checkbox: null,
        },
        {
          id: 5,
          code: "5",
          description: "Ocupação irregular",
          checkbox: null,
        },
        {
          id: 6,
