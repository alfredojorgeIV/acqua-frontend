    ...
    <div class="content">
      <section>
        <div class="intro-services-to-be-billed">
          <h1 class="title-page">Motivo do corte</h1>
        </div>
    ...
    return {
      ...
      cutReasonTable: [
        ...
        },
        {
          id: 2,
          code: "2",
          description: "Desligamento a pedido",
          checkbox: null,
        },
        {
          id: 3,
          code: "3",
          description: "Falta de pagamento",
          checkbox: null,
        },
        {
          id: 4,
          code: "4",
          description: "Corte técnico POS 0104",
          checkbox: null,
        },
        {
          id: 5,
          code: "5",
          description: "Corte técnico ANT 0104",
          checkbox: null,
        },
        {
          id: 6,
          code: "6",
          description: "Lote vazio",
          checkbox: null,
        },
        {
          id: 7,
          code: "7",
          description: "Terreno baldio",
          checkbox: null,
        },
        {
          id: 8,
          code: "8",
          description: "Ligação somente esgoto",
          checkbox: null,
        },
        {
          id: 9,
          code: "9",
          description: "Atender a decisão judicial",
          checkbox: null,
        },
      ],
    };
