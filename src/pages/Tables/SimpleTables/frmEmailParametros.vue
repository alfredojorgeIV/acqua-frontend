        ...
        <div class="content">
            <section>
                <div class="intro-services-to-be-billed">
                    <h1 class="title-page">E-mail Parâmetros</h1>
                </div>
                <div class="flex gap-4">
                    <div class="w-61 margin-top-30">
                        ...
                        <DataTable style="border-bottom-left-radius: 10px; border-bottom-right-radius: 10px !important;"
                            :value="taxCategoryTable" tableStyle="min-width: 50rem" :paginator="true" :rows="10"
                    ...
                    <div class="w-35">
                        <div class="box-tables-info" v-if="selectedRow && !showAddBox">
                            ...
                            <input v-model="selectedRow.CATEGORIA" class="inputs margin-bottom-30"
                                :disabled="!isEditing" />
                            <p class="p-labels">Descrição</p>
                            <input v-model="selectedRow.DESC_CATEGORIA" class="inputs margin-bottom-30"
                                :disabled="!isEditing" />
                            <p class="p-labels">Descrição reduzida</p>
                            <input v-model="selectedRow.DESC_REDUZIDA" class="inputs margin-bottom-30"
                                :disabled="!isEditing" />
