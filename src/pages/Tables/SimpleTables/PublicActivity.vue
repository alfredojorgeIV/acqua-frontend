    ...
    <div class="content">
      <section>
        <div class="intro-services-to-be-billed">
          <h1 class="title-page">Atividade Pública</h1>
        </div>
      ...
      publicActivityTable: [
        {
          id: 0,
          code: '0',
          description: 'Não é possível informar',
          checkbox: null,
        },
        {
          id: 1,
        ...
        },
        {
          id: 4,
          code: '4',
          description: 'Entidade filantrópica',
          checkbox: null,
        },
        {
          id: 5,
          code: '5',
          description: 'Entidade religiosa',
          checkbox: null,
        },
        {
          id: 6,
