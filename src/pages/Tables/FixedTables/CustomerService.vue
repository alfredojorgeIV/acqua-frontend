    ...
    <div class="content">
      <section>
        <div class="intro-services-to-be-billed">
          <h1 class="title-page">Serviço de Atendimento</h1>
        </div>
        ...
        <div class="margin-top-30">
          ...
          <DataTable style="border-bottom-left-radius: 10px; border-bottom-right-radius: 10px !important;"
            :value="customerServiceTable" tableStyle="min-width: 50rem" :paginator="true" :rows="10" dataKey="id"
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        this.customerServiceTable = response.data;
      } catch (error) {
